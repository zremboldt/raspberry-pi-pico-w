...
# We have a triangle. The hypotenuse is 2. The angle is 30 degrees.
hypotenuse = 2
angle = 30

# What is the length of the opposite side?
print(hypotenuse * math.sin(degreesToRadians(angle))) # 1.0

# What is the length of the adjacent side?
print(hypotenuse * math.cos(degreesToRadians(angle))) # 1.73
